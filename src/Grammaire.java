                                    ...
                                    parser.function();
                                        ...
                                        while(!stack.empty())
                                        {
                                                ...
                                                if(workedExecutions.size() != 0) {
                                                        ...
                                                        String[] executedPaths = Utilities.BuildPath(executions);
                                                        ...
                                                        System.out.println(nbIndependantPaths + " / " + nbPaths + " soit " + pourcentage + "% des chemins d'\u00e9x\u00e9cution couverts");
                                                }else
                                                        System.out.println("Aucune e");
